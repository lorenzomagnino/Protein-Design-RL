...
if __name__ == "__main__":
    ...
    args.variable_length = True #Problem 2 uses variable sequence length in the training
    ...
    if args.mode==2: 
        #path to laod
        name = f"{args.algo}_Protein_Design_rng_length.zip"
        model_path = os.path.join(args.dir, name)
        best_model_path = f"{args.algo}_Protein_Design_rng_length"
